...
public class FPGA
{
    ...
    public static unsafe void BlockImageWrite(int address, byte* data, int length)
    {
        {
            int xx = EPT_AH_SendBlock(address, (void*)data, (uint)length);
        }
    }
